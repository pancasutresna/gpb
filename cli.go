...
func (cli *CLI) printUsage() {
	...
	fmt.Println("	printchain -print print all the blocks of the blockchain")
	fmt.Println("	reindexutxo  - Rebuilds the UTXO set")
	fmt.Println("	send -from FROM -to TO -amount AMOUNT - Send AMOUNT of coins from FROM address to TO")
	fmt.Println("	startnode -miner ADDRESS - Start a node tih ID specified in the NODE_ID env. var. -miner enables mining")
}
...
func (cli *CLI) Run() {
	...
	if nodeID == "" {
		fmt.Printf("NODE_D env. var is not set!")
		os.Exit(1)
	}
